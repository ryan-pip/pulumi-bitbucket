module github.com/ryan-pip/pulumi-bitbucket/provider
...
replace (
	github.com/DrFaust92/terraform-provider-bitbucket/v2 => ../upstream
...
require (
	github.com/DrFaust92/terraform-provider-bitbucket/v2 v2.40.0
...
require (
	...
	github.com/DrFaust92/bitbucket-go-client v0.10.0 // indirect
