...
class GetGroupsResult:
    ...
    """
    def __init__(__self__, groups=None, id=None, workspace=None):
...
def get_groups(workspace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bitbucket:index/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult).value
