...
namespace Pulumi.Bitbucket
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Bitbucket.version.txt");
    ...
    internal sealed class BitbucketResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BitbucketResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
